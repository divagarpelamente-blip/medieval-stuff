...
const Modal = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    <div className="absolute inset-0 bg-black/90 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-[#f4e4bc] w-full max-w-lg sm:max-w-2xl max-h-[85%] rounded-xl border-[8px] border-[#5d4037] shadow-[0_0_50px_rgba(0,0,0,0.9)] relative flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        {/* Body */}
        <div className="p-6 sm:p-10 overflow-y-auto flex-grow relative z-10 text-[#2d1b0d] scrollbar-thin scrollbar-thumb-[#8b4513] scrollbar-track-transparent">
          {children}
        </div>
