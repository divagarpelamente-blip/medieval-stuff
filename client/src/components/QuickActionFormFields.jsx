...
const QuickActionFormFields = ({
  ...
  const rowSpacing = isCompact ? "space-y-1.5" : "space-y-2.5";
  const gridGap = isCompact ? "gap-1.5" : "gap-2";
  const labelMargin = isCompact ? "mb-0.5" : "mb-1";
  const inputHeight = isCompact ? "h-[29px]" : "h-[34px]";
  const formPadding = isCompact ? "p-1 pr-1" : "p-2.5 mb-2.5";
      ...
      <div className={`grid grid-cols-12 ${gridGap} items-end`}>
        <div className="col-span-12 sm:col-span-6">
          ...
          <input
            ...
            required
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-3 text-xs font-bold text-[#4b2c20] placeholder-[#5d4037]/45 focus:outline-none focus:border-[#8b4513]/50`}
          />
        </div>
        <div className="col-span-12 sm:col-span-6">
      ...
      <div className={`grid grid-cols-12 ${gridGap} items-end`}>
        <div className="col-span-12 sm:col-span-3">
          ...
          <select
            ...
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-2 text-xs font-bold text-[#4b2c20] focus:outline-none focus:border-[#8b4513]/50`}
          >
        ...
        <div className="col-span-12 sm:col-span-3">
          ...
          <select
            ...
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-2 text-xs font-bold text-[#4b2c20] focus:outline-none`}
          >
      ...
      <div className={`grid grid-cols-12 ${gridGap} items-end`}>
        ...
        <div className="col-span-12 sm:col-span-3">
          ...
          <select
            ...
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-2 text-xs font-bold text-[#4b2c20] focus:outline-none focus:border-[#8b4513]/50 font-sans`}
          >
        ...
        <div className="col-span-12 sm:col-span-3">
          ...
          <input
            ...
            placeholder="Amount"
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-3 text-xs font-bold text-[#4b2c20] placeholder-[#5d4037]/45 focus:outline-none focus:border-[#8b4513]/50 font-mono`}
          />
        </div>
      </div>
      ...
      <div className={`grid grid-cols-12 ${gridGap} items-end`}>
        <div className="col-span-12 sm:col-span-3">
          ...
          <input
            ...
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-3 text-xs font-bold text-[#4b2c20] focus:outline-none focus:border-[#8b4513]/50 font-mono`}
          />
        </div>
        <div className="col-span-12 sm:col-span-3">
      ...
      <div className={`grid grid-cols-12 ${gridGap} items-end`}>
        <div className="col-span-12 sm:col-span-6">
          ...
          <select
            ...
            className={`w-full bg-[#faf4e5]/80 border border-[#8b4513]/20 rounded-lg ${inputHeight} px-2 text-xs font-bold text-[#4b2c20] focus:outline-none focus:border-[#8b4513]/50 font-mono`}
          >
